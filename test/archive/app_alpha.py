...
def update_potential_(potential):
...
def update_potential(potential, has_negative_one=True):
...
if __name__ == "__main__":
    ...
    for i in range(1501):
        ...
        pc = update_potential(potential, has_negative_one)
        ...
        # plot
        if ((i%50 == 0 and not has_negative_one) or (i%10 == 0 and has_negative_one)):
        # if (i%10 == 0):
            print('frame ', i)
